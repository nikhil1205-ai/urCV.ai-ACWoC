                            ...
                            <div className="space-y-4">
                                {data.education.map((edu) => (
                                    <div key={edu.id}>
                                        ...
                                        <p className="text-orange-600 font-semibold">{edu.school}</p>
                            ...
                            {Object.entries(data.codingProfiles || {}).map(([platform, url]) => {
                                ...
                                return (
                                    <div key={platform} className="flex items-center gap-2">
                                        <span className="font-bold text-orange-600">{platform.charAt(0).toUpperCase() + platform.slice(1)}:</span>
                                        <span className="text-gray-700 text-sm break-all">{url}</span>
                                    </div>
                                );
                            })}
                        </div>
