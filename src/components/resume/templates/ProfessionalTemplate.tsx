...
const ProfessionalTemplate = ({ data }: TemplateProps) => {
  return (
    <div
      className="bg-white p-12 min-h-[1200px] font-serif text-gray-900 max-w-[850px] mx-auto"
    ...
    >
      ...
      {data.personalInfo.summary && (
        <section className="mb-8">
          <h2 className="text-sm font-bold uppercase border-b border-gray-400 mb-3 pb-1">
      ...
      {data.experience.length > 0 && (
        <section className="mb-8">
          <h2 className="text-sm font-bold uppercase border-b border-gray-400 mb-4 pb-1">
            Work Experience
          </h2>
